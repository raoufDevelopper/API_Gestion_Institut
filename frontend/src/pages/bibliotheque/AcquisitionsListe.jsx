      ...
      <div className="department-page">
        ...
        <div className="department-card table-card">
          ...
          <div className="table-title">
            <h2>Acquisitions</h2>
            <span>{acquisitions.length} Acquisitions</span>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} id="departmentForm">
            ...
            <div className="form-grid">
              ...
              <div className="form-group">
                <label>Date</label>
                <input type="date" {...register('date_acquisition')} />
              </div>
              
              <div className="form-group">
                <label>Fournisseur</label>
                <select {...register('fournisseur')}>
              ...
              <div className="form-group">
                ...
                {lignes.map((l, i) => (
                  <div key={i} style={{ display: 'flex', gap: '8px', marginBottom: '8px', alignItems: 'center' }}>
                    ...
                    <input type="number" min="1" value={l.quantite} onChange={(e) => modifierLigne(i, 'quantite', e.target.value)} style={{ width: '95px' }} />
                    <input type="number" step="0.01" placeholder="Prix unit." value={l.prix_unitaire} onChange={(e) => modifierLigne(i, 'prix_unitaire', e.target.value)} style={{ width: '130px' }} />
                    <button type="button" className="edt-btn-supprimer" onClick={() => supprimerLigne(i)}><i className="fas fa-times"></i></button>
                  </div>
                ))}
              
                <button type="button" className="edt-btn-ajouter" onClick={ajouterLigne}>
                  +
                </button>
