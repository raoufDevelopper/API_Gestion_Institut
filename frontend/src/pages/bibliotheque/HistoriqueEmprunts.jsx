  ...
  return (
    <div className="container-principal">
      <div className="department-page">
        <div className="panel-head"><h3 style={{ fontSize: '20px' }}>Historique des emprunts</h3></div>
        ...
        <div className="department-card table-card">
          <div className="table-title"><h2>Historique des emprunts</h2><span>{emprunts.length}</span></div>
          <div className="table-scroll">
            <table>
              <thead><tr><th>N° Emprunt</th><th>Ressource</th><th>Exemplaire</th><th>Emprunteur</th><th>Date emprunt</th><th>Date retour</th><th>Statut</th></tr></thead>
              <tbody>
                {pageActuelle.map((e) => (
                  <tr key={e.id}>
                    ...
                    <td><span className={`badge ${BADGE_STATUT_EMPRUNT[e.statut]}`}><span className="dot"></span>{STATUTS_EMPRUNT.find((s) => s.value === e.statut)?.label}</span></td>
                  </tr>
                ))}
