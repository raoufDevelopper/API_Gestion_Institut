          ...
          <div className="dash-contenu">
            ...
            <div className="dash-graphique-card">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                <div className="edt-alerte-conflits" style={{ margin: 0, background: '#fec3c3', borderColor: 'rgba(249,115,22,.15)', color: '#854d0e' }}><i className="fas fa-fire"></i><div>{alertes.livres_tres_demandes} livre(s) très demandé(s)</div></div>
                ...
                <div className="edt-alerte-conflits" style={{ margin: 0, background: '#fec3c3', borderColor: 'rgba(249,115,22,.15)', color: '#854d0e' }}><i className="fas fa-screwdriver-wrench"></i><div>{alertes.exemplaires_endommages} exemplaire(s) endommagé(s)</div></div>
