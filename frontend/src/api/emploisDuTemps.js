...
export const telechargerEmploiDuTempsPdf = (id) => api.get(`academique/emplois-du-temps/${id}/export-pdf/`, { responseType: 'blob' });

export const getSeances = (emploiDuTempsId) => api.get(`academique/seances/?emploi_du_temps=${emploiDuTempsId}`);
