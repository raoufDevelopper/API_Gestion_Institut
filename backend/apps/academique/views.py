...
#@permission_requise('voir_niveaux')
...
@api_view(['GET', 'POST'])
@permission_classes([IsAuthenticated])
#@permission_requise('voir_filieres')
...
@api_view(['GET', 'POST'])
@permission_classes([IsAuthenticated])
#@permission_requise('voir_specialites')
...
@api_view(['GET', 'POST'])
@permission_classes([IsAuthenticated])
@permission_requise('voir_salles')
...
@api_view(['GET', 'POST'])
@permission_classes([IsAuthenticated])
#@permission_requise('voir_matieres')
...
@api_view(['GET', 'POST'])
@permission_classes([IsAuthenticated])
#@permission_requise('voir_annees_academiques')
...
@api_view(['GET', 'POST'])
@permission_classes([IsAuthenticated])
#@permission_requise('voir_classes')
...
@api_view(['GET', 'POST'])
@permission_classes([IsAuthenticated])
#@permission_requise('voir_emplois_du_temps')
...
@api_view(['GET', 'POST'])
@permission_classes([IsAuthenticated])
#@permission_requise('voir_seances')
...
@api_view(['GET', 'POST'])
@permission_classes([IsAuthenticated])
#@permission_requise('voir_sanctions')
