...
class Diplome(models.Model):
    ...
    deliberation = models.OneToOneField('notes.Deliberation', on_delete=models.PROTECT, related_name='diplome')
    ...
    fichier = models.FileField(upload_to='documents/diplomes/', storage=RawMediaCloudinaryStorage(), blank=True, null=True)
    
    signe_par = models.ForeignKey('utilisateurs.Personnel', on_delete=models.SET_NULL, null=True, blank=True, related_name='diplomes_signes')
    ...
    genere_par = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='diplomes_generes')
...
class Certificat(models.Model):
    ...
    fichier = models.FileField(upload_to='documents/certificats/', storage=RawMediaCloudinaryStorage(), blank=True, null=True)

    genere_par = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='certificats_generes')
...
class Document(models.Model):
    ...
    fichier = models.FileField(upload_to='documents/autres/', storage=RawMediaCloudinaryStorage())
