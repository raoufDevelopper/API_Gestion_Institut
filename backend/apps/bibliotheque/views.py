...
from .serializers import CategorieSerializer, LivreSerializer, ExemplaireSerializer, EmpruntSerializer, ReservationSerializer, PenaliteSerializer
...
@permission_requise('gerer_bibliotheque')
